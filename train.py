...
if __name__ == "__main__":
    ...
    utils.run_train(model= model, train_loader= train_loader, test_loader= test_loader, is_cuda= is_cuda, train_params= train_params, weights_path= args.weights_path)
